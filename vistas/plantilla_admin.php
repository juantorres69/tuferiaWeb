...
<html lang="en">
    <head>
        ...
        <!-- SITE TITLE -->
        <title>Tu Feria Virtual - admin</title>
    ...
    <body>
        ...
        <?php 
            ...
            */
            ...
            if(isset($_GET['ruta']) && $_GET['ruta'] != 'admin'){
                ...
                $item = "ruta";
                $valor = $rutas[0];
                $whiteListGeneric = array("productos","perfil","categorias", "detalle-productos", "comercios", "configuracion", "publicidad", "compras");
                if(in_array($valor, $whiteListGeneric)){
                    include "modulos/super/".$valor.".php";    
                }
            }else{
                include "modulos/super/admin.php";
            }   
        ...
        <?php if($rutas[0] == 'categorias'){?>
            <script src="<?php echo $url; ?>vistas/js/super/categorias.js"></script>
        <?php } ?>

        <?php if($rutas[0] == 'detalle-productos'){?>
            <script src="<?php echo $url; ?>vistas/js/super/detalles_productos.js"></script>
        <?php } ?>

        <?php if($rutas[0] == 'comercios'){?>
            <script src="<?php echo $url; ?>vistas/js/super/comercios.js"></script>
        <?php } ?>

        <script src="<?php echo $url; ?>vistas/js/super/config.js"></script>

        <?php if($rutas[0] == 'publicidad'){?>
            <script src="<?php echo $url; ?>vistas/js/super/publicidad.js"></script>
        <?php } ?>

        
        <?php if($rutas[0] == 'compras'){?>
            <script src='<?php echo $url; ?>vistas/assets/js/excelexportjs.js'></script>
            <script src="<?php echo $url; ?>vistas/js/super/compras.js"></script>
        <?php } ?>
