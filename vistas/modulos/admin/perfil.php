<!-- START PERFIL EXPOSITORES -->
<input type="hidden" id="hdUrl" value="<?php echo $url; ?>">
<div class="main_content container-heigth-fluid" style="min-height: calc(100vh - 134px - 85px ) !important;">    
        ...
        <div class="custom-container">
            <div class="">
                <div class="">
                    <div class="row">
                        <div class="col-12 ">
                            <div class="heading_tab_header" style="margin-top: 10px;">
                                <!-- USER NAME -->
                                ...
                                <div class="tab-style2">
                                    ...
                                    <ul class="nav nav-tabs justify-content-center justify-content-md-end" id="tabmenubar" role="tablist" style="margin: 0px 0px -148px 0px;">
                                        <li class="nav-item">
