        ...
        <div class="custom-container">
            <div class="">
                <div class="">
                    ...
                    <div class="row">
                        <div style="display: flex; justify-content: space-between;" class="col-md-12 mb-3">
                            <h4>Productos</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control form-control-file" name="imagen_1">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <img src="<?php echo $url; ?>assets/images/productos/no-imagen.png" class="img-thumbnail w-25 img-prod d-none">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control form-control-file" name="imagen_2">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <img src="<?php echo $url; ?>assets/images/productos/no-imagen.png" class="img-thumbnail w-25 img-prod d-none">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control form-control-file" name="imagen_3">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <img src="<?php echo $url; ?>assets/images/productos/no-imagen.png" class="img-thumbnail w-25 img-prod d-none">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control form-control-file" name="imagen_4">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
